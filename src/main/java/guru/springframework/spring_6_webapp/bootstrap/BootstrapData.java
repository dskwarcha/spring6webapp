...
public class BootstrapData implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        Publisher examplePub = new Publisher();
        examplePub.setPublisherName("Example Pub");
        examplePub.setAddress("Example Address");
        examplePub.setCity("Example City");
        examplePub.setState("Example State");
        examplePub.setZip("Example Zip");

        Publisher examplePubSaved = publisherRepository.save(examplePub);

        dddSaved.setPublisher(examplePubSaved);
        noEJBSaved.setPublisher(examplePubSaved);
